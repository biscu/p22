    ...
    <Theme>
        <div className="App">
          <Wrapper>
            ...
            <Block
            symbol="❖"
            title="Gathering customer's feedbacks"
            ...
            <Block
            symbol="❖"
            title="The security screen needed some clean up"
            ...
            <Block
            symbol="❖"
            title="The app wasn't mentioned on web"
            ...
            <Block
            symbol="❖"
            title="App confirmation was needed for the disenrollment"
